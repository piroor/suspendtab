...
prefs.setDefaultPref(domain+'autoSuspend.newBackgroundTab.afterLoad', false);
...
prefs.setDefaultPref(domain+'menu.contentContext_suspend', true);
prefs.setDefaultPref(domain+'menu.contentContext_toggleTabSuspendException', true);
prefs.setDefaultPref(domain+'menu.contentContext_suspendOthers', true);
prefs.setDefaultPref(domain+'menu.contentContext_suspendTree', true);
prefs.setDefaultPref(domain+'menu.contentContext_resumeTree', true);
prefs.setDefaultPref(domain+'debug', false);
prefs.setDefaultPref(domain+'debug.content', false);
